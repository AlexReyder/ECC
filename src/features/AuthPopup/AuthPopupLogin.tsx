  ...
  return (
    <FormContainer className={className}>
      ...
      <FormFooter>
        ...
        <Link href="/password-recovery" className="inner__reset">
          Восстановить пароль
        </Link>
        <div>
          <span className="inner__bottom__text">Еще нет аккаунта?</span>
          <Link href="/signup" className="btn-reset inner__switch">
            Зарегистрироваться!
          </Link>
        </div>
      </FormFooter>
